...
class TopFragment: ProductListBigFragment() {
    ...
    private fun subscribeToTopProducts() {
        productViewModel.topProducts().observe(viewLifecycleOwner, Observer { productList ->
